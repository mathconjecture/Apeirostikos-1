...
\end{enumerate}}
        ...
        \myprop{$ (a_{n})_{n \in \mathbb{N}} $ φραγμένη $ \Leftrightarrow \exists 
        M>0, \; M \in \mathbb{R} \; : \; \abs{a_{n}} \leq M, \; \forall 
        n \in \mathbb{N} $ (Απολύτως φραγμένη).}
...
\myprop{Η ακολουθία $ \left(1 + \frac{1}{n} \right)^{n} $ είναι φραγμένη.}
...
\begin{cor}
    ...
    \begin{minipage}{0.25\textwidth}
        \begin{enumerate}[i)]
            \item $ \abs{a_{n}} \leq b_{n}, \; \forall n \in 
                \mathbb{N} $ \hfill \tikzmark{a}
...
\myprop{$ \lim_{n \to \infty} x^{n} = +\infty, \; x >1 $.}
...
\mythm{Κάθε φραγμένη ακολουθία πραγματικών αριθμών έχει συγκλίνουσα 
υπακολουθία.}
