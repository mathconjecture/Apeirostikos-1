...
\begin{center}
    \minibox[frame,c]{\large \bfseries Πραγματικοί Αριθμοί \\ \large 
    \bfseries Ορισμοί}
\end{center}
...
\item {}
    \begin{itemize}[label=\textbf{\tiny$\blacksquare$}]
        \item Αν $ M $ άνω φράγμα του $A$ και \boldmath{$M \in A$} τότε $M$ λέγεται 
...
\begin{dfn}
    ...
    \begin{itemize}[label=\textcolor{Col1}{\tiny$\blacksquare$}]
        \item $ M \in \mathbb{R} $ \textbf{supremum} του $A$ (
            $ \boldmath{M = \sup A} $ ) 
